    ...
    const onSubmit = (data, e) => {
        ...
        auth.login(() => { 
            ...
            .then(function (response) {
                ...
                if (user.blocked === false && user.confirmed === true && user.role.type=== "customer") {
                    history.push("/user")
                    localStorage.setItem('token', response.data.jwt)
                    localStorage.setItem('user', 'user')
                    localStorage.setItem('email', response.data.user.email)
                    localStorage.setItem('loggedIn', true)
                    // localStorage.setItem('details', response.data.user)
                }
                else if (user.blocked === false && user.confirmed === true && user.role.type=== "authenticated") {
                    history.push("/merchant")
                    localStorage.setItem('token', response.data.jwt)
                    ...
                    alert('Your account has not been confirmed or has been blocked please contact Admin')
                }
