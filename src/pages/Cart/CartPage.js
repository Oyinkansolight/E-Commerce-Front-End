                                ...
                                <TableRow key={row.id}>
                                    <TableCell>
                                        <ListItemAvatar>
                                            <Avatar
                                                alt={row.name}
                                                src={`${baseURL}${row.displayImg.formats.thumbnail.url}`}
                                            />
                                        </ListItemAvatar>
                                        {row.name}
                                    </TableCell>
                                    <TableCell align="center">
                                        ...
                                        <ButtonGroup size="small" disableElevation variant="contained" color="default">
                                            <Button onClick={() => {
                                                setControlQty(false)
                                                dispatchCart({type: 'SUB_QTY', payload: row})
                                                }}>
                                                <RemoveIcon />
                                            </Button>
                                            ...
                                            onClick={() => {
                                                ...
                                                dispatchCart({type: 'ADD_QTY', payload: row})}
